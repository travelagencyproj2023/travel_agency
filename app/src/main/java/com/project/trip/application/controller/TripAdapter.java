...
public class TripAdapter extends RecyclerView.Adapter<TripAdapter.StudentHolder> {
    private Context context;
    private List<AddTripModel> tripsList;
    ...
    public TripAdapter(Context context, List<AddTripModel> list,String type) {
    ...
    public void onBindViewHolder(StudentHolder holder, int position) {
        final AddTripModel model = tripsList.get(position);

        holder.title.setText(model.getTitle());
        //gs://trip-app-69906.appspot.com/add_trip/1675478542126.jpg
        try {
            holder.imageTrip.setImageBitmap(decodeFromFirebaseBase64(model.getImageURL()));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        if(type == "booked"){
            ...
            holder.btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    builder1.setMessage("هل تريد الحجز وإتمام عملية الدفع");
                    ...
                    builder1.setPositiveButton(
                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    AddTripModel model2 = new AddTripModel(model.getTitle(), model.getImageURL());
                                    //adding an upload to firebase database
                                    String uploadId = mDatabaseRef.push().getKey();
                                    mDatabaseRef.child(uploadId).setValue(model2);
