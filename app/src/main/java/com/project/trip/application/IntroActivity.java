...
import com.project.trip.application.controller.IntroViewPagerAdapter;
import com.project.trip.application.model.ScreenItem;
...
//        }
        ...
        mList.add(new ScreenItem("خطط لرحلتك", R.drawable.travel_page_one));
        mList.add(new ScreenItem("إحجز رحلتك المفضلة", R.drawable.travel_page_two));
        mList.add(new ScreenItem("إكتشف معنا... وعيش مغامراتك القادمة", R.drawable.travel_page_three));
        //Setup viewPager
